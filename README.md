...
Kaggle challenge) consists of approximately <img src="svgs/68c2ac99cce135079f03b73f2508b4d9.svg?invert_in_darkmode" align=middle width=32.876837399999985pt height=21.18721440000001pt/> CSV files, each of which
...
<p align="center"><img src="svgs/21917a98875f92ca834ead32fb5e1743.svg?invert_in_darkmode" align=middle width=125.07536415pt height=30.1801401pt/></p>

This function transforms a day of year on the interval <img src="svgs/1e9479532e84c4b91ced8a8aca717e88.svg?invert_in_darkmode" align=middle width=49.31516864999999pt height=24.65753399999998pt/> into a real number on a
continuous interval from <img src="svgs/9df6b91c7d6cd45f445b4b4480294a5e.svg?invert_in_darkmode" align=middle width=34.70324219999999pt height=24.65753399999998pt/>. Under this transformation, day
<img src="svgs/a0a281a58c85511aa52fc3089abf726a.svg?invert_in_darkmode" align=middle width=24.657628049999992pt height=21.18721440000001pt/> and day <img src="svgs/034d0a6be0424bffe9a6e7ac9236c0f5.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> will have similar values, capturing the idea that
...
<p align="center"><img src="svgs/73ca72dd4bc41905aabe484a9d3e3ea6.svg?invert_in_darkmode" align=middle width=196.3105155pt height=33.81208709999999pt/></p>
...
record by looking <img src="svgs/332cc365a4987aacce0ead01b8bdcc0b.svg?invert_in_darkmode" align=middle width=9.39498779999999pt height=14.15524440000002pt/> days into the future and calculating a pointwise
or aggregate measure of closing price over those <img src="svgs/332cc365a4987aacce0ead01b8bdcc0b.svg?invert_in_darkmode" align=middle width=9.39498779999999pt height=14.15524440000002pt/> days. One such
strategy is to calculate a pointwise percent change in
price as follows, where <img src="svgs/77a3b857d53fb44e33b53e4c8b68351a.svg?invert_in_darkmode" align=middle width=5.663225699999989pt height=21.68300969999999pt/> indicates an index of the record to be
labeled:

<p align="center"><img src="svgs/7a448631210d242b0b4963216a2770b9.svg?invert_in_darkmode" align=middle width=149.43388349999998pt height=36.09514755pt/></p>

Another strategy is to calculate an aggregate of some price metric
over <img src="svgs/332cc365a4987aacce0ead01b8bdcc0b.svg?invert_in_darkmode" align=middle width=9.39498779999999pt height=14.15524440000002pt/> days in the future and calculate percent change from the present
price to that aggregate price. For example, one could calculate an average closing
price over the following <img src="svgs/332cc365a4987aacce0ead01b8bdcc0b.svg?invert_in_darkmode" align=middle width=9.39498779999999pt height=14.15524440000002pt/> days and then calculate percent change
in closing price from the present to that average.

<p align="center"><img src="svgs/4e59936e7d8bb68b24c0ebea46288d23.svg?invert_in_darkmode" align=middle width=303.0574371pt height=49.794650399999995pt/></p>
...
calculated relative to the average closing price over a future <img src="svgs/5dc642f297e291cfdde8982599601d7e.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> day
window.
...
2. Normalizer - A strategy to normalize each feature to a shared
	...
	* `MaxAbsScaler` - Rescales each feature to the range <img src="svgs/e88c070a4a52572ef1d5792a341c0900.svg?invert_in_darkmode" align=middle width=32.87674994999999pt height=24.65753399999998pt/>,
		**preserving sparsity**
...
that the <img src="svgs/55a049b8f161ae7cfeb0197d75aff967.svg?invert_in_darkmode" align=middle width=9.86687624999999pt height=14.15524440000002pt/>'th bucket contains the top <img src="svgs/2d77e685bfa7e0c249fa2e10b3d67677.svg?invert_in_darkmode" align=middle width=26.30529494999999pt height=24.65753399999998pt/>'th percent change values.
...
a bucket parameter list of <img src="svgs/7c08e246e40a911344a4f63745e12edb.svg?invert_in_darkmode" align=middle width=80.36535375pt height=21.18721440000001pt/>. This produced five discretized
...
As a concrete example, consider training example <img src="svgs/77a3b857d53fb44e33b53e4c8b68351a.svg?invert_in_darkmode" align=middle width=5.663225699999989pt height=21.68300969999999pt/> with features
<img src="svgs/e4ee64ce87613f7cbd2dcdf02f2612a5.svg?invert_in_darkmode" align=middle width=83.13913904999998pt height=22.831056599999986pt/> and a window size of <img src="svgs/332cc365a4987aacce0ead01b8bdcc0b.svg?invert_in_darkmode" align=middle width=9.39498779999999pt height=14.15524440000002pt/>. Example <img src="svgs/77a3b857d53fb44e33b53e4c8b68351a.svg?invert_in_darkmode" align=middle width=5.663225699999989pt height=21.68300969999999pt/> would then consist
of features over the <img src="svgs/332cc365a4987aacce0ead01b8bdcc0b.svg?invert_in_darkmode" align=middle width=9.39498779999999pt height=14.15524440000002pt/> previous days for that stock as follows:

<p align="center"><img src="svgs/479088446b465de276a3db582a119125.svg?invert_in_darkmode" align=middle width=375.3076008pt height=108.49422870000001pt/></p>

The result of this process is an intuitively constructed training
example, consisting of an ordered time series of features over the <img src="svgs/332cc365a4987aacce0ead01b8bdcc0b.svg?invert_in_darkmode" align=middle width=9.39498779999999pt height=14.15524440000002pt/>
...
is applied to two adjacent records, <img src="svgs/77a3b857d53fb44e33b53e4c8b68351a.svg?invert_in_darkmode" align=middle width=5.663225699999989pt height=21.68300969999999pt/> and <img src="svgs/48a0115fc523b1aae58ade9e16001f59.svg?invert_in_darkmode" align=middle width=33.97362704999999pt height=21.68300969999999pt/>. The result will be
two training examples with <img src="svgs/6168db5ca031b9b37e74ce5c0ac732c0.svg?invert_in_darkmode" align=middle width=37.70538914999999pt height=21.18721440000001pt/> feature matrices which have a
substantial overlap. Specifically, we will produce feature matrices as
follows:

<p align="center"><img src="svgs/75d1142cb18a52dc33e5a71216e96faa.svg?invert_in_darkmode" align=middle width=554.7163974pt height=145.73587544999998pt/></p>

Applying a stride greater than <img src="svgs/034d0a6be0424bffe9a6e7ac9236c0f5.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> to the historical window will
reduce the amount of overlap between feature matrices, creating a
more diverse training set. For experimentation a stride of <img src="svgs/9612eecfec9dadf1a81d296bd2473777.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> days
was chosen. This resulted in an adequate number of training examples
and minimized the overlap in the <img src="svgs/5dc642f297e291cfdde8982599601d7e.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> day future percent change
window.
...
training set produced from <img src="svgs/675eeb554f7b336873729327dab98036.svg?invert_in_darkmode" align=middle width=32.876837399999985pt height=21.18721440000001pt/> stock symbols from <img src="svgs/28152ca58dcfc4ec27f45fef65cc0292.svg?invert_in_darkmode" align=middle width=32.876837399999985pt height=21.18721440000001pt/> to <img src="svgs/38f86e2f958b2cbcb5e8344a839fea3b.svg?invert_in_darkmode" align=middle width=32.876837399999985pt height=21.18721440000001pt/>
with a window size of <img src="svgs/1e0fe6183c7bbc89521f14af6a035751.svg?invert_in_darkmode" align=middle width=24.657628049999992pt height=21.18721440000001pt/> days and a window stride of <img src="svgs/034d0a6be0424bffe9a6e7ac9236c0f5.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/>. Assume
the stock only trades <img src="svgs/88db9c6bd8c9a0b1527a1cedb8501c55.svg?invert_in_darkmode" align=middle width=24.657628049999992pt height=21.18721440000001pt/> days out of the year.  The
number of resultant examples is given by

<p align="center"><img src="svgs/6f5b1fbc3ca82b7bfbe7508e8e4a27b6.svg?invert_in_darkmode" align=middle width=224.1322809pt height=40.182651299999996pt/></p>

Similarly, if we consider this process applied the entirety of the
dataset without constraint

<p align="center"><img src="svgs/96ed46c5e521b95f562030670eca5da6.svg?invert_in_darkmode" align=middle width=224.1322809pt height=40.182651299999996pt/></p>

We will have a <img src="svgs/110fb9d1a8c67745584a783cb430df5c.svg?invert_in_darkmode" align=middle width=52.968029399999985pt height=21.18721440000001pt/> feature matrix per row.
If we assume that each feature and the percent change is stored as a
<img src="svgs/9b316764e592d513c7c6be2b9e112d73.svg?invert_in_darkmode" align=middle width=16.438418699999993pt height=21.18721440000001pt/> bit float and the label is stored as an <img src="svgs/005c128d6e551735fa5d938e44e7a613.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> bit integer, we can
calculated the expected size of the resultant training set in

<p align="center"><img src="svgs/e41d4da6f05c52e2004cf59fffb52c0c.svg?invert_in_darkmode" align=middle width=213.04829865pt height=86.30137065pt/></p>
...
default there are four levels of downsampling with <img src="svgs/b3762e99b2048db4b426cb0a322f783f.svg?invert_in_darkmode" align=middle width=54.79448699999999pt height=21.18721440000001pt/>
bottleneck block repeats respectively. During experimentation, it was
found that a <img src="svgs/5e431d07072989254bd3b03e63d49636.svg?invert_in_darkmode" align=middle width=63.01369634999999pt height=21.18721440000001pt/> level repeat structure was more robust, and
is shown below:
...
2. **Batch size** - Tune this as needed for your hardware. It is
	 ...
	 A batch size of <img src="svgs/9684129ebb778f48019391de80875252.svg?invert_in_darkmode" align=middle width=24.657628049999992pt height=21.18721440000001pt/> was typically used for experiments.

3. **Learning rate** - Learning rate can be tuned directly, with
	 values around <img src="svgs/242af53be4184a6239b4e559e992fd45.svg?invert_in_darkmode" align=middle width=37.44306224999999pt height=21.18721440000001pt/> tending to work well. A learning rate greater
	 than <img src="svgs/22f2e6fc19e491418d1ec4ee1ef94335.svg?invert_in_darkmode" align=middle width=21.00464354999999pt height=21.18721440000001pt/> often hindered the training process, likely due to the
...
categorical accuracy and top <img src="svgs/76c5792347bb90ef71cfbace628572cf.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> categorical accuracy. Due to the
...
accuracy for several (interrupted) runs. Validation top <img src="svgs/034d0a6be0424bffe9a6e7ac9236c0f5.svg?invert_in_darkmode" align=middle width=8.219209349999991pt height=21.18721440000001pt/> categorical
accuracy reached as high as <img src="svgs/bbb5e0fdc90354a025c504e65ad6d0a9.svg?invert_in_darkmode" align=middle width=30.137091599999987pt height=24.65753399999998pt/>, while top 2 categorical accuracy
reached <img src="svgs/cd35c23d6f29694a2ad05d4e8225b7f6.svg?invert_in_darkmode" align=middle width=30.137091599999987pt height=24.65753399999998pt/>. The model took between five and ten minutes per epoch depending
on choice of batch size, which each epoch containing on average
<img src="svgs/d601dc72767f0373f93eb363dbe3270f.svg?invert_in_darkmode" align=middle width=56.62113929999999pt height=21.18721440000001pt/> training examples. Note that this training set was a
...
4. Expanding the one dimensional convolution input to two dimensions
	 by including the top <img src="svgs/55a049b8f161ae7cfeb0197d75aff967.svg?invert_in_darkmode" align=middle width=9.86687624999999pt height=14.15524440000002pt/> correlated stocks over each training
